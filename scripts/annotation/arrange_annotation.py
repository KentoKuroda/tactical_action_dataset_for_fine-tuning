...
def main():
    ...
    for video_id in video_ids:
        for anno_id in anno_ids:
            # XMLファイルの読み込み
            xml_file = f'data/raw/annotation/{video_id}_{team_id}/{video_id}_{anno_id}_{team_id}.xml'

            # TXTファイルの読み込み
            txt_file = f'data/raw/video/videolist_{video_id}.txt'

            # output file
            output_file = f'data/raw/annotation/{video_id}_{team_id}/{video_id}_{anno_id}_{team_id}.json'
